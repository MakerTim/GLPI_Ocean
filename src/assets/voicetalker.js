...
// responsiveVoice.speak("Hallo allemaal", 'Dutch Female')
...
if (typeof responsiveVoice === 'undefined') {
	if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice); else var ResponsiveVoice = function () {
		...
		a.responsivevoices = [{
			name: "UK English Female", flag: "gb", gender: "f", lang: "en-GB", voiceIDs: [3, 7, 171, 278, 201,
			...
			name: "Arabic Female", flag: "ar", gender: "f",
			lang: "ar-SA", voiceIDs: [98]
			...
			name: "Deutsch Female", flag: "de", gender: "f", lang: "de-DE", voiceIDs: [27, 28,
			...
			name: "French Female", flag: "fr", gender: "f",
			lang: "fr-FR", voiceIDs: [240, 21, 22, 23, 77, 178, 279, 210, 266, 295, 351, 304, 321, 360, 26]
		}, {
			name: "French Male",
			flag: "fr",
			gender: "m",
			...
			flag: "hu", gender: "f", lang: "hu-HU", voiceIDs: [9, 10, 81, 214, 11]
		}, {
			name: "Hungarian Male",
			flag: "hu",
			gender: "m",
		...
		}, {name: "Italian Male", flag: "it", gender: "m", lang: "it-IT", voiceIDs: [312, 329, 368, 406]},
			{
				...
				name: "Latin Male", flag: "va",
				gender: "m", lang: "la", voiceIDs: [165]
			}, {
				...
				flag: "br", gender: "m", lang: "pt-BR", voiceIDs: [400]
			}, {
				...
				name: "Vietnamese Female", flag: "vi", gender: "f", lang: "vi-VN",
				voiceIDs: [405]
			}, {
				...
				name: "Esperanto Male", flag: "eo", gender: "m", lang: "eo",
				voiceIDs: [108]
				...
				name: "Serbian Male", flag: "sr", gender: "m",
				lang: "sr-RS", voiceIDs: [12]
			}, {
		...
		a.voicecollection = [{name: "Google UK English Male"}, {name: "Agnes"}, {name: "Daniel Compact"}, {name: "Google UK English Female"}, {
			...
			{name: "ingl\u00e9s Reino Unido"}, {name: "English United Kingdom"}, {
				...
				name: "Fallback Bosnian Male", lang: "bs", fallbackvoice: !0,
			...
			{name: "German Germany"}, {name: "alem\u00e1n Alemania"}, {
				...
				timerSpeed: 1
			}, {name: "English United States"}, {name: "ingl\u00e9s Estados Unidos"},
			{name: "Vicki"}, {name: "en-US", rate: .2, pitch: 1, timerSpeed: 1.3}, {
				...
				name: "Fallback Chinese", lang: "zh-CN", fallbackvoice: !0, service: "g1",
				gender: "female"
			...
			}, {name: "Fallback Swahili", lang: "sw", fallbackvoice: !0, service: "g1", gender: "male"},
			{
				...
				name: "sv-SE",
				rate: .25
			}, {name: "Simona Compact"}, {name: "Ioana"}, {name: "ro-RO", rate: .25},
		...
		a.init = function () {
			...
			"undefined" === typeof speechSynthesis ? (console.log("RV: Voice synthesis not supported"), a.enableFallbackMode()) : setTimeout(function () {
				var b = setInterval(function () {
					...
					0 != c.length || null != a.systemvoices && 0 != a.systemvoices.length ? ('', a.systemVoicesReady(c), clearInterval(b)) : (console.log("Voice support NOT ready"), a.voicesupport_attempts++, a.voicesupport_attempts > a.VOICESUPPORT_ATTEMPTLIMIT && (clearInterval(b), null != window.speechSynthesis ?
...
if (typeof jQuery === 'undefined') {
	...
	!function (a, b) {
		...
		var aa = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ba = /<([\w:]+)/,
			...
			fa = /^$|\/(?:java|ecma)script/i, ga = /^true\/(.*)/, ha = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
			ia = {
	...
	e.fn.hoverIntent = function (a, l, p) {
		var b = {interval: 100, sensitivity: 6, timeout: 0},
			b = "object" === typeof a ? e.extend(b, a) : e.isFunction(l) ? e.extend(b, {
				...
				out: l,
				selector: p
			}) : e.extend(b, {over: a, out: a, selector: l}), f, g, h, k, m = function (b) {
				f = b.pageX;
				g = b.pageY
			}, n = function (a, d) {
...
var config = JSON.parse('{\"welcomeMessage\":false,\"speakSelectedText\":false,\"speakLinks\":false,\"speakInactivity\":false,\"speakEndPage\":false,\"exitIntent\":false,\"accesibilityNavigation\":false,\"accesibilityNavigation2\":false,\"welcomeMessageTime\":false,\"text_welcomeMessage\":\"\",\"text_speakInactivity\":\"\",\"text_speakEndPage\":\"\",\"text_exitIntent\":\"\",\"trackEvents\":false,\"abTesting\":false,\"analytics_id\":null,\"analyticsSettings\":{\"date\":\"2019-03-22\",\"period\":\"month\"}}');
	...
	setTimeout(function () {
		...
		if (!splitTestEnabled || (splitTestEnabled && splitTest_useGS)) {
			...
			if (txt != null && txt != "") {
				...
				responsiveVoice.speak("According to Voicebrite, " + txt, 'Dutch Female');
			}
		}
...
jQuery(window).on('load', function () {
	...
	jQuery('a').hoverIntent(function () {
		...
		if (config.speakLinks) {
			...
			responsiveVoice.speak(jQuery(this).text(), 'Dutch Female');
	...
	function onMouseUp() {
		...
		if (selectedText != last_selectedText && selectedText != "") {
			...
			responsiveVoice.speak(selectedText, 'Dutch Female'); //speak the text as returned by getSelectionText
	...
	if (config.welcomeMessage && (!config.welcomeMessageTime || oneTimeTest("welcomeMessage")) && !isPrerendered() && !prerenderUsed) {
		...
		setTimeout(function () {
			if (config.text_welcomeMessage != null && config.text_welcomeMessage != "") {
				...
				responsiveVoice.speak(GetRandomMsg(config.text_welcomeMessage), 'Dutch Female');
	...
	if (!welcomeMessageLaunched && config.welcomeMessage2 && (!config.welcomeMessageTime || oneTimeTest("welcomeMessage2"))
		...
		welcomeMessage2Interval = setInterval(function () {
			...
			if (!isPrerendered() && !welcomeMessage2Launched) {
				...
				responsiveVoice.speak(GetRandomMsg(config.text_welcomeMessage2), 'Dutch Female');
	...
	function timerIncrement() {
		...
		if (idleTime >= 30000) {
			responsiveVoice.speak(GetRandomMsg(config.text_speakInactivity), 'Dutch Female');
	...
	function exitIntent(e) {
		if (e.clientY < 0) {
			responsiveVoice.speak(GetRandomMsg(config.text_exitIntent), 'Dutch Female');
	...
	if (config.accesibilityNavigation) {
		$('a').keyup(function (e) {
			...
			if (code == '9') {
				responsiveVoice.speak('Link 2 ' + $(':focus').text(), 'Dutch Female');
		...
		$('button').keyup(function (e) {
			...
			var code = e.keyCode || e.which;
			if (code == '9') {
				setTimeout(responsiveVoice.speak($(':focus').text() + ' button', 'Dutch Female'), 1000);
				trackEvent('agentFeature', 'accesibilityNavigation', 'tab');
			}
		});
		$('textarea').keyup(function (e) {
			...
			if (code == '9') {
				...
				responsiveVoice.speak('Text Input ' + $(':focus').attr('placeholder'), 'Dutch Female');
				trackEvent('agentFeature', 'accesibilityNavigation', 'tab');
			}
		});
	}
	if (config.accesibilityNavigation2) {
		$('body').keyup(function (e) {
			...
			if (code == '40' && e.ctrlKey) {
				...
				responsiveVoice.speak($('p').eq(started).text(), 'Dutch Female');
